...
export type entropyBits = (total: number, risk: number) => number
export type entropyBitsPerChar = (chars: string) => number
...
export type puid = (puidConfig: PuidConfig) => PuidResult
